package ru.java.project3d.controller;


import ru.java.project3d.ui.Editor3D;
                ...
                try {
                    switch (no) {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            editor3D.addNewModel();
                            break;
                        case 9:
                            System.out.print("Укажите номер модели: ");
                            if (scanner.hasNextInt()) {
                                int modelDeleteNo = scanner.nextInt();
                                scanner.nextLine();
                                editor3D.deleteModel(modelDeleteNo);
                            } else {
                                System.out.println("Номер модели указан некорректно.");
                            }
                            break;
                        case 10:
                            System.out.print("Укажите номер модели: ");
                            if (scanner.hasNextInt()) {
                                int modelEditNo = scanner.nextInt();
                                scanner.nextLine();
                                editor3D.editModel(modelEditNo);
                            } else {
                                System.out.println("Номер модели указан некорректно.");
                            }
